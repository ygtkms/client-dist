...
Scheme
{
	...
	Colors
	{
		...
		"BrightBaseText"		"255 170 40 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"160 160 160 255"	// dim base text
		"LabelDimText"		"145 145 145 220"	// used for info text
		"ControlText"		"225 225 225 255"	// used in all text controls
		"BrightControlText"	"255 145 20 255"	// use for selected controls
		"DisabledText1"		"85 85 85 255"	// disabled text
		"DisabledText2"		"15 15 15 180"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"130 130 130 255"	// offline friends, unsubscribed games, etc.

		"ButtonFocusBorder"	"255 130 0 255"	// keyboard focus dashed line for buttons

		// background colors
		"ControlBG"			"24 24 24 235"		// background color of most controls
		"ButtonBG"			"32 32 32 230"		// background color of buttons
		"ControlDarkBG"		"15 15 15 245"		// darker background color; used for background of scrollbars
		"WindowBG"			"24 24 24 240"		// background color of text edit panes (chat, text entries, etc.)
		//"SelectionBG"		"192 28 0 140"	// background color of any selected text or menu item
		"SelectionBG"		"230 96 0 220"	// background color of any selected text or menu item
		"SelectionBG2"		"255 128 0 90"		// selection background in window w/o focus
		"ListBG"			"30 30 30 235"		// background of scoreboard
		"ViewportBG"		"10 10 10 220"
		"CareerBoxBG"		"14 14 14 235"
		"Menu/BgColor"		"18 18 18 238"

		// Credits ------------------------------------------------
		"CreditsNormalFG"	"235 235 235 255"
		"CreditsNormalBG"	"0 0 0 255"

		"CreditsTitleFG"	"255 145 20 255"
		"CreditsTitleBG"	"0 0 0 255"

		"CreditsStudioTitleFG"	"255 145 20 255"
		"CreditsStudioTitleBG"	"0 0 0 255"

		"CreditsIndividualTitleFG"	"255 145 20 255"
		"CreditsIndividualTitleBG"	"0 0 0 255"
		// --------------------------------------------------------

		// titlebar colors
		"TitleText"			"255 170 40 255"
		"TitleDimText"		"160 100 45 255"
		"TitleBG"			"18 18 18 245"
		"TitleDimBG"		"18 18 18 210"
		"TitleIcon"		"255 145 20 255" // big '!' icon in top left
		
		// slider tick colors
		"SliderTickColor"		"255 145 20 255"
		"SliderTrackColor"	"60 60 60 255"

		// border colors
		"BorderBright"		"255 128 0 255"	// the lit side of a control
		"BorderDark"		"100 50 0 255"	// the dark/unlit side of a control
		"BorderSelection"		"255 145 20 255"	// the additional border color for displaying the default/selected button
		"BorderBuyPreset"		"255 145 20 255"	// the lit side of a control
		...
		// Statistics text
		"StatisticsText"		"230 230 230 255"
		"SelectedStatisticsText"	"255 145 20 255"

		"BuyPresetBG"			"26 26 26 220"
		"BuyPresetAltBG"		"38 38 38 225"

		"MapDescriptionText"	"255 165 40 255" // the text used in the map description window
	}
