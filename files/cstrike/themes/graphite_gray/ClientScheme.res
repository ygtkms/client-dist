...
Scheme
{
	...
	Colors
	{
		...
		"DimBaseText"		"145 145 145 255"	// dim base text
		"LabelDimText"		"135 135 135 210"	// used for info text
		"ControlText"		"220 220 220 255"	// used in all text controls
		"BrightControlText"	"245 245 245 255"	// use for selected controls
		"DisabledText1"		"85 85 85 255"	// disabled text
		"DisabledText2"		"0 0 0 0"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"125 125 125 255"	// offline friends, unsubscribed games, etc.

		"ButtonFocusBorder"	"120 130 140 255"	// keyboard focus dashed line for buttons

		// background colors
		"ControlBG"			"18 18 18 238"		// background color of most controls
		"ButtonBG"			"34 34 34 225"		// background color of buttons
		"ControlDarkBG"		"8 8 8 240"		// darker background color; used for background of scrollbars
		"WindowBG"			"16 16 16 242"		// background color of text edit panes (chat, text entries, etc.)
		//"SelectionBG"		"82 90 98 140"	// background color of any selected text or menu item
		"SelectionBG"		"82 90 98 235"	// background color of any selected text or menu item
		"SelectionBG2"		"82 90 98 75"		// selection background in window w/o focus
		"ListBG"			"12 12 12 242"		// background of scoreboard
		"ViewportBG"		"0 0 0 220"
		"CareerBoxBG"		"10 10 10 236"
		"Menu/BgColor"		"10 10 10 236"

		// Credits ------------------------------------------------
		"CreditsNormalFG"	"220 220 220 255"
		"CreditsNormalBG"	"0 0 0 255"

		"CreditsTitleFG"	"245 245 245 255"
		"CreditsTitleBG"	"0 0 0 255"

		"CreditsStudioTitleFG"	"245 245 245 255"
		"CreditsStudioTitleBG"	"0 0 0 255"

		"CreditsIndividualTitleFG"	"245 245 245 255"
		"CreditsIndividualTitleBG"	"0 0 0 255"
		// --------------------------------------------------------

		// titlebar colors
		"TitleText"			"245 245 245 255"
		"TitleDimText"		"125 125 125 255"
		"TitleBG"			"8 8 8 245"
		"TitleDimBG"		"8 8 8 235"
		"TitleIcon"		"245 245 245 255" // big '!' icon in top left
		
		// slider tick colors
		"SliderTickColor"		"125 125 125 255"
		"SliderTrackColor"	"38 38 38 255"

		// border colors
		"BorderBright"		"115 122 130 255"	// the lit side of a control
		"BorderDark"		"35 35 35 255"	// the dark/unlit side of a control
		"BorderSelection"		"150 160 170 255"	// the additional border color for displaying the default/selected button
		"BorderBuyPreset"		"115 122 130 255"	// the lit side of a control

		"team0"			"210 210 210 255" // Spectators
		"team1"			"255 90 90 255" // CT's
		"team2"			"120 185 255 255" // T's

		// Statistics text
		"StatisticsText"		"220 220 220 255"
		"SelectedStatisticsText"	"245 245 245 255"

		"BuyPresetBG"			"18 18 18 190"
		"BuyPresetAltBG"		"34 34 34 210"

		"MapDescriptionText"	"220 220 220 255" // the text used in the map description window
	}
