...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"218 228 236 255"	// used in text windows, lists
		"BrightBaseText"		"115 210 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"145 160 172 255"	// dim base text
		"LabelDimText"		"140 155 168 200"	// used for info text
		"ControlText"		"218 228 236 255"	// used in all text controls
		"BrightControlText"	"115 210 255 255"	// use for selected controls
		"DisabledText1"		"82 94 105 255"	// disabled text
		"DisabledText2"		"0 0 0 0"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"132 148 160 255"	// offline friends, unsubscribed games, etc.

		"ButtonFocusBorder"	"50 165 230 255"	// keyboard focus dashed line for buttons

		// background colors
		"ControlBG"			"14 20 30 238"		// background color of most controls
		"ButtonBG"			"23 31 44 225"		// background color of buttons
		"ControlDarkBG"		"8 13 21 240"		// darker background color; used for background of scrollbars
		"WindowBG"			"17 25 38 242"		// background color of text edit panes (chat, text entries, etc.)
		//"SelectionBG"		"192 28 0 140"	// background color of any selected text or menu item
		"SelectionBG"		"28 115 180 235"	// background color of any selected text or menu item
		"SelectionBG2"		"28 115 180 75"		// selection background in window w/o focus
		"ListBG"			"13 21 33 242"		// background of scoreboard
		"ViewportBG"		"5 10 18 220"
		"CareerBoxBG"		"10 16 26 236"
		"Menu/BgColor"		"10 16 26 236"

		// Credits ------------------------------------------------
		"CreditsNormalFG"	"220 230 238 255"
		"CreditsNormalBG"	"5 10 18 255"

		"CreditsTitleFG"	"115 210 255 255"
		"CreditsTitleBG"	"5 10 18 255"

		"CreditsStudioTitleFG"	"115 210 255 255"
		"CreditsStudioTitleBG"	"5 10 18 255"

		"CreditsIndividualTitleFG"	"115 210 255 255"
		"CreditsIndividualTitleBG"	"5 10 18 255"
		// --------------------------------------------------------

		// titlebar colors
		"TitleText"			"115 210 255 255"
		"TitleDimText"		"88 125 150 255"
		"TitleBG"			"10 16 26 245"
		"TitleDimBG"		"10 16 26 235"
		"TitleIcon"		"115 210 255 255" // big '!' icon in top left
		
		// slider tick colors
		"SliderTickColor"		"90 165 210 255"
		"SliderTrackColor"	"25 65 95 255"

		// border colors
		"BorderBright"		"45 160 225 255"	// the lit side of a control
		"BorderDark"		"15 55 85 255"	// the dark/unlit side of a control
		"BorderSelection"		"70 185 240 255"	// the additional border color for displaying the default/selected button
		"BorderBuyPreset"		"45 160 225 255"	// the lit side of a control
		...
		// Statistics text
		"StatisticsText"		"220 230 238 255"
		"SelectedStatisticsText"	"110 205 255 255"

		"BuyPresetBG"			"14 20 30 190"
		"BuyPresetAltBG"		"23 31 44 210"

		"MapDescriptionText"	"180 225 250 255" // the text used in the map description window
	}
